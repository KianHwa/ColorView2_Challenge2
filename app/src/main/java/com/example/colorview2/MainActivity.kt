...
class MainActivity : AppCompatActivity() {
    ...
    private fun makeColored(view: View) {
        when (view.id) {
            ...
            R.id.box_thirteen_text -> view.setBackgroundColor(Color.BLACK)
            R.id.box_fourteen_text -> view.setBackgroundColor(Color.GREEN)
            R.id.box_fifteen_text -> view.setBackgroundColor(Color.BLUE)
            R.id.box_sixteen_text -> view.setBackgroundColor(Color.CYAN)
    ...
    private fun setListeners() {
        ...
        val clickableViews: List<View> =
            listOf(
                boxOneText, boxTwoText, boxThreeText, boxFourText, boxFiveText, boxSixText, boxSevenText, boxEightText,
                boxNineText, boxTenText, boxElevenText, boxTwelveText, boxThirteenText, boxFourteenText, boxFifteenText,
                boxSixteenText, boxSeventeenText, rootConstraintLayout
            )
